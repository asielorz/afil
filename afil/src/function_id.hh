...
namespace function_id_constants
{
	constexpr FunctionId invalid = {FunctionId::Type::intrinsic, (1u << 30u) - 1u};
	constexpr FunctionId deleted = {FunctionId::Type::intrinsic, (1u << 30u) - 2u};
	...
	constexpr FunctionId is_array = {FunctionId::Type::intrinsic, 220};
}
