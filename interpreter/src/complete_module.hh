...
namespace complete
{
	...
	auto is_default_constructible(TypeId type, Module const & module) noexcept -> bool;
	...
	auto array_type_for(TypeId pointee_type, int size, Module & module) noexcept -> TypeId;
	...
	auto array_pointer_type_for(TypeId value_type, Module & module) noexcept -> TypeId;
